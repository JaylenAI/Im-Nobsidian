...
> 마지막 업데이트: 2026-07-16
> 버전: v0.3.0 릴리스 완료 (2026-07-14 태그·npm 배포) · v0.3.1 개발 중

## v0.3.1 — 실데이터 충실도 마감 5-Phase (진행 중)
...
| 5     | clean-slate 실데이터 E2E + v0.3.1 릴리스                    | ⏳ 진행 예정   |

상세: `journal/2026-07-16.md`, `adr/008-nfm-design-fidelity.md`
...
**v0.3.0 릴리스 완료(2026-07-14), v0.3.1 실데이터 충실도 마감 진행 중.** 1245 테스트.
...
- **전체**: 1245개 통과 (11 skip, 0 실패) — 99 테스트 파일 (3 skip)
